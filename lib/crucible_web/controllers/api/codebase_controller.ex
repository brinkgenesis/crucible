defmodule CrucibleWeb.Api.CodebaseController do
  ...
  operation(:index,
    ...
    tags: ["Codebase"],
    responses: [ok: {"Module list", "application/json", %OpenApiSpex.Schema{type: :array, items: %OpenApiSpex.Schema{type: :object}}}]
  )
  ...
  operation(:symbols,
    ...
    tags: ["Codebase"],
    responses: [ok: {"Symbol list", "application/json", %OpenApiSpex.Schema{type: :array, items: %OpenApiSpex.Schema{type: :object}}}]
  )
  ...
  operation(:references,
    ...
    tags: ["Codebase"],
    responses: [ok: {"Reference list", "application/json", %OpenApiSpex.Schema{type: :array, items: %OpenApiSpex.Schema{type: :object}}}]
  )
  ...
  operation(:impact,
    ...
    description: "Returns dependents and transitive dependents for a module (not yet implemented).",
    tags: ["Codebase"],
  ...
  operation(:codebase_health,
    ...
    description: "Returns a health score and policy violations for the codebase (not yet implemented).",
    tags: ["Codebase"],
  ...
  operation(:graph,
    ...
    description: "Returns the full module dependency graph as nodes and edges (not yet implemented).",
    tags: ["Codebase"],
